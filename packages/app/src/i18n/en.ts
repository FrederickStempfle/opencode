export const dict = {
  ...
  "command.goal.toggle": "Set goal",
  "command.goal.toggle.description": "Keep working until a condition is met (/goal <condition>)",
  ...
  "session.panel.add": "Add",
  "session.panel.addTerminal": "Add terminal",
  "session.panel.newDiff": "New diff",
